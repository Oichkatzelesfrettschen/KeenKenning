/*
 * KenningSkillModelInference.kt: ONNX-based skill prediction for adaptive difficulty
 *
 ...
 */
class KenningSkillModelInference(private val context: Context) : SkillModelInference {
    ...
    companion object {
        ...
        private var instance: KenningSkillModelInference? = null

        @JvmStatic
        fun getInstance(context: Context): KenningSkillModelInference {
            return instance ?: synchronized(this) {
                instance ?: KenningSkillModelInference(context.applicationContext).also {
                    instance = it
                }
            }
        }
