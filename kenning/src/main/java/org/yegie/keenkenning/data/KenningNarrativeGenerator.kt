/*
 * KenningNarrativeGenerator.kt: AI-powered narrative generation for Story mode
 *
 * Hybrid approach:
 ...
 */
class KenningNarrativeGenerator private constructor(private val context: Context) : NarrativeGenerator {
    ...
    companion object {
        ...
        private var instance: KenningNarrativeGenerator? = null

        @JvmStatic
        fun getInstance(context: Context): KenningNarrativeGenerator {
            return instance ?: synchronized(this) {
                instance ?: KenningNarrativeGenerator(context.applicationContext).also {
                    instance = it
                }
            }
        }
