...
public class KeenModel {
    ...
    public static class GridCell
    {
        ...
        public float[] aiProbabilities; // [0] unused, [1..N] probs
    ...
    private int size;
    private boolean wasAiGenerated;

    //constructor that initializes everything to the default values
    public KeenModel(int size, Zone[] zones, GridCell[][] grid, boolean wasAiGenerated)
    {
        this.size = size;
        this.gameGrid = grid;
        this.undo = new Stack<>();
        ...
        this.wasAiGenerated = wasAiGenerated;
        activeX = -1;
        activeY = -1;
    }

    /** Whether the puzzle was generated using AI */
    public boolean wasAiGenerated() { return wasAiGenerated; }
