...
data class RenderableGameState(
    ...
    /** Whether the grid was AI-generated */
...
data class RenderableCell(
    ...
    /** AI probability hints per digit [0..size], index 0 unused, indices 1-size are probabilities */
    val aiProbabilities: FloatArray?,
...
object GameStateTransformer {
    ...
    fun transform(
        ...
        return RenderableGameState(
            ...
            gameMode = gameMode,
            isAiGenerated = model.wasAiGenerated(),
        ...
        return (0 until size).map { x ->
            (0 until size).map { y ->
                ...
                RenderableCell(
                    ...
                    zoneId = zone?.code ?: 0,
                    aiProbabilities = cell?.aiProbabilities,
                    borders = borders,
...
fun RenderableCell.toUiCell(zones: List<RenderableZone>): UiCell {
    ...
    return UiCell(
        ...
        notes = pencilMarks,
        smartHintProbs = aiProbabilities?.toList(),
        zoneId = zoneId,
