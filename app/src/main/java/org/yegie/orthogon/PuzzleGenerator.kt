 ...
 *
 * Wraps the legacy KenKenModelBuilder with sealed result types and
...
import org.yegie.orthogon.data.PuzzleGenerationResult
...
class PuzzleGenerator {
    ...
    private val legacyBuilder = KenKenModelBuilder()
        ...
        return try {
            ...
            if (model != null) {
                ...
                PuzzleGenerationResult.Failure.NativeGenerationFailed(
                    message = "KenKenModelBuilder returned null"
                )
            }
