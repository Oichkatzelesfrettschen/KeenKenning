...
sealed interface PuzzleGenerationResult {
     ...
     * @param wasMlGenerated Whether ML was used for Latin square generation
     * @param generationTimeMs Time taken to generate (for profiling)
     */
    data class Success(
        val model: KenKenModel,
        val wasMlGenerated: Boolean,
    ...
    sealed interface Failure : PuzzleGenerationResult {
        ...
        /** ML model failed to produce valid Latin square */
        data class MlGenerationFailed(
            override val message: String = "ML generation failed",
 ...
 */
fun PuzzleGenerationResult.getModelOrNull(): KenKenModel? =
