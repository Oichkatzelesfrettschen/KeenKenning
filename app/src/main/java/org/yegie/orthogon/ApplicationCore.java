...
import static org.yegie.orthogon.MenuActivity.DARK_MODE;
import static org.yegie.orthogon.MenuActivity.MENU_DIFF;
import static org.yegie.orthogon.MenuActivity.MENU_MULT;
import static org.yegie.orthogon.MenuActivity.MENU_SIZE;
...
//        return isDarkMode;
    ...
    public void setCanCont(boolean canCont) {
        ...
        editor.putBoolean(KenKenActivity.CAN_CONT,canCont);
        editor.apply();
    ...
    public void onCreate() {
        ...
        canCont= sharedPref.getBoolean(KenKenActivity.CAN_CONT,false);
