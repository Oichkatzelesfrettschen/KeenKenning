/*
 * ClassikSkillModelInference.kt: Heuristic skill prediction for adaptive difficulty (Classik)
 *
 ...
 */
class ClassikSkillModelInference(private val context: Context) : SkillModelInference {

    companion object {
        @Volatile
        @android.annotation.SuppressLint("StaticFieldLeak")
        private var instance: ClassikSkillModelInference? = null

        @JvmStatic
        fun getInstance(context: Context): ClassikSkillModelInference {
            return instance ?: synchronized(this) {
                instance ?: ClassikSkillModelInference(context.applicationContext).also {
                    instance = it
                }
            }
        }
     ...
     */
    override fun predictSkill(features: SkillFeatures): Float {
     ...
     */
    override fun recommendDifficulty(skillScore: Float, gridSize: Int): Int {
